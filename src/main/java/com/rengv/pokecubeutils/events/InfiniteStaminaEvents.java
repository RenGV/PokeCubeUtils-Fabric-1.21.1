...
public class InfiniteStaminaEvents {
    public static void register() {
        CobblemonEvents.RIDE_EVENT_APPLY_STAMINA.subscribe(event -> {
            ...
            if (!PermissionHelper.hasCommandPermission(player.getCommandSource(), "pokecube.infinite.ride")
                || (player.getWorld().equals(PokeCubeUtils.EVENT_WORLD) && !EventManager.INFINITE_RIDE_STAMINE)) {
